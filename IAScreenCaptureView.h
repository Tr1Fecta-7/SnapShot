 ...
 */
@protocol IAScreenCaptureViewDelegate <NSObject>
 ...
 *
 */
@interface IAScreenCaptureView : UIView {
    //video writing
...
@property(nonatomic, assign) id<IAScreenCaptureViewDelegate> delegate;
